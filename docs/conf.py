# -*- coding: utf-8 -*-
#
# Geneblocks documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../geneblocks/"))
...
htmlhelp_basename = "Geneblocksdoc"
...
latex_documents = [
    ("index", "Geneblocks.tex", "Geneblocks Documentation", "Zulko", "manual")
]
...
man_pages = [("index", "Geneblocks", "PACKAGE_NAME Documentation", ["Zulko"], 1)]
