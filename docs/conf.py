...
latex_documents = [
    ("index", "Geneblocks.tex", u"Geneblocks Documentation", u"Zulko", "manual")
]
...
man_pages = [
    ("index", "Geneblocks", u"PACKAGE_NAME Documentation", [u"Zulko"], 1)
]
